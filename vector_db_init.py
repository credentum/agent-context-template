#!/usr/bin/env python3
"""
vector_db_init.py: Initialize Qdrant vector database for the Agent-First Context System

This script:
1. Checks if Qdrant is running
2. Creates the project_context collection
3. Sets up vector configuration
4. Initializes indexes
"""
    ...
    def create_collection(self, force: bool = False) -> bool:
        ...
        try:
            ...
            if exists and not force:
                click.echo(f"Collection '{collection_name}' already exists. Use --force to recreate.")
                return True
    ...
    def insert_test_point(self) -> bool:
        ...
        try:
            ...
            if results and results[0].id == "test-point-001":
                ...
                self.client.delete(
                    collection_name=collection_name,
                    points_selector=["test-point-001"]
                )
                return True
            else:
