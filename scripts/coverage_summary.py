...
class CoverageSummary:
    ...
    def generate_report(self):
        ...
        results = [
            ...
            ("Branch Coverage", coverage_metrics['branch_coverage'], self.targets['branch_coverage']),
            ("Mutation Score", mutation_score, self.targets['mutation_score']),
            ("Critical Functions", (critical_covered/critical_total*100 if critical_total else 0), self.targets['critical_function_coverage'])
        ]
