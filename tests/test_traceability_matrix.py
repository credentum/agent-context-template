...
CRITICAL_FUNCTIONS = {
    ...
    "src.storage.context_kv.ContextKV.acquire_lock": {
        ...
        "test_cases": [
            "test_context_kv_coverage.py::TestContextKVCoverage::test_lock_operations"
        ],
    ...
    "src.storage.graph_builder.GraphBuilder.process_document": {
        ...
        "test_cases": [
            "test_graph_db.py::TestGraphBuilder::test_process_document"
        ],
    ...
    "src.validators.kv_validators.validate_session_data": {
        ...
        "test_cases": [
            "test_kv_store.py::TestKVValidators::test_validate_session_data"
        ],
    ...
    "src.analytics.context_analytics.ContextAnalytics.analyze_health": {
        ...
        "test_cases": [
            "test_e2e.py::TestEndToEnd::test_performance_config_workflow"
        ],
    ...
    def test_generate_traceability_report(self, tmp_path):
        ...
        report = {
            "summary": {
                ...
                "functions_with_tests": sum(1 for info in CRITICAL_FUNCTIONS.values() if info["test_cases"]),
                "total_test_cases": sum(len(info["test_cases"]) for info in CRITICAL_FUNCTIONS.values()),
                "total_requirements": len(set(req for info in CRITICAL_FUNCTIONS.values() for req in info["requirements"]))
            },
        ...
        assert report["summary"]["functions_with_tests"] == report["summary"]["total_critical_functions"]
