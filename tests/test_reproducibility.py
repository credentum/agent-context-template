...
class TestReproducibility:
    ...
    def test_graph_state_reproducibility(self, tmp_path):
        ...
        graph_snapshot = {
            "nodes": [
                {"id": "sprint-001", "labels": ["Sprint", "Document"], "properties": {"title": "Sprint 1"}},
                {"id": "decision-001", "labels": ["Decision", "Document"], "properties": {"title": "Decision 1"}}
            ],
            "relationships": [
                {"start": "sprint-001", "end": "decision-001", "type": "REFERENCES"}
            ],
            "metadata": {
                "node_count": 2,
        ...
        graph_snapshot["metadata"]["snapshot_hash"] = \
            hashlib.sha256(snapshot_str.encode()).hexdigest()
    ...
    def test_audit_checkpoint_creation(self, test_data_dir, tmp_path):
        ...
        checkpoint["verification"]["total_hash"] = \
            hashlib.sha256(state_str.encode()).hexdigest()
