...
class TestSprintUpdater:
    ...
    def temp_context_dir(self):
        ...
        # Create test config
        config = {"agents": {"pm_agent": {"sprint_duration_days": 14}}}
            ...
            "phases": [
                {
                    ...
                    "name": "Setup",
                    "status": "pending",
                    "tasks": ["Define YAML schema with yamale", "Implement context-lint CLI"],
                }
            ],
            "created_date": "2025-01-01",
            "start_date": "2025-01-01",
    ...
    def test_task_matching_logic(self):
        ...
        for task, issue_title, expected in test_cases:
            ...
            assert (
                result == expected
            ), f"Task '{task}' vs '{issue_title}' - expected {expected}, got {result}"
            ...
            "phases": [
                {
                    ...
                    "name": "Implementation",
                    "status": "pending",
                    "tasks": ["Implement feature A", "Write tests for feature A"],
                }
            ],
            "created_date": "2025-01-01",
            "start_date": "2025-01-01",
